...
@class SBChromeApplication, SBChromeWindow, SBChromeTab, SBChromeBookmarkFolder, SBChromeBookmarkItem;
...
@interface SBChromeApplication : SBApplication
...
// A window.
@interface SBChromeWindow : SBObject
...
@property (copy, readonly) SBChromeTab *activeTab;  // Returns the currently selected tab
...
// The application's top-level scripting object.
@interface SBChromeApplication (ChromiumSuite)

- (SBElementArray *) bookmarkFolders;

@property (copy, readonly) SBChromeBookmarkFolder *bookmarksBar;  // The bookmarks bar bookmark folder.
@property (copy, readonly) SBChromeBookmarkFolder *otherBookmarks;  // The other bookmarks bookmark folder.

@end

// A tab.
@interface SBChromeTab : SBObject
...
@interface SBChromeBookmarkFolder : SBObject
...
@interface SBChromeBookmarkItem : SBObject
